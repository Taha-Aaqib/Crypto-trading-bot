...
class AutoRetrainer:
    ...
    def __init__(self, config_path: str = 'config/config.yaml'):
        ...
        # Retraining parameters (conservative for LSTM - expensive to retrain)
        ml_config = self.config.get('ml_model', {})
        self.retrain_interval_days = ml_config.get('retrain_interval_days', 30)
        self.min_win_rate = 0.55  # Retrain if win rate drops below 55%
        self.min_new_trades = 30  # Retrain after 30 new trades
